...
urlpatterns = [
    ...
    path('animes/<int:anime_id>/recommend/',
         views.add_recommendation, name='add_recommendation'),
    path('api/anime-search/', views.search_anime_autocomplete,
         name='anime_search_autocomplete'),
]
